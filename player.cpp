...
Player::Player(Vector2f p_pos, SDL_Texture* p_tex, SDL_Texture* p_pointTex, SDL_Texture* p_healthMTexFG, SDL_Texture* p_healthMTexBG)
    :Entity(p_pos, p_tex)
{
    setScale(1.5, 1.5);
...
void Player::update(double deltaTime, bool keyDown, std::vector<Tile> tiles)
{
